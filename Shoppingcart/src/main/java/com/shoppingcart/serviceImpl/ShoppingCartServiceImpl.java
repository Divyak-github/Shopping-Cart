...
public class ShoppingCartServiceImpl implements ShoppingCartService {
	...
	public void pickAndAddToBasket(List<Category> loadedCategories, int maxRating) throws Exception {
		...
		if(loadedCategories != null)
		{
			try 
			{
				...
				while (isReadyToBePicked()) 
				{
					generateFinalBasket(localPickedItems);
				}
	...
	/**
	 * @param localPickedItems
	 */
	public void generateFinalBasket(List<Item>localPickedItems)
	{
	...
	public boolean isReadyToBePicked()
	{
